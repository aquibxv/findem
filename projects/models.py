...
class Project(models.Model):
    ...
    skill_2 = models.CharField(max_length=40, blank=True, null=True)
    skill_3 = models.CharField(max_length=40, blank=True, null=True)
    skill_4 = models.CharField(max_length=40, blank=True, null=True)
    photo_1 = models.ImageField(upload_to='', blank=True, null=True) 
